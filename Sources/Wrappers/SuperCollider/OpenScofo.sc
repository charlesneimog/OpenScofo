OpenScofo : UGen {
    *ar { arg in = 0.0, sampleRate = 48000.0, fftSize = 2048.0, hopSize = 512.0;
        ^this.multiNew('audio', in, sampleRate, fftSize, hopSize)
    }

    *kr { arg in = 0.0, sampleRate = 48000.0, fftSize = 2048.0, hopSize = 512.0;
    ...
    *findUnitIndex { arg synth;
        ...
        openScofoUGen = children.detect({ |ugen| ugen.class == OpenScofo });
    ...
    *cmd { arg synth, command, args;
        ...
        // 'args' should be an array; use expand to send each element
