...
class VampOpenScofo : public Vamp::Plugin {
  public:
    VampOpenScofo(float inputSampleRate);
    virtual ~VampOpenScofo();
  ...
  private:
    void RefreshScorePathsFromEnv();
    bool LoadScoreAtIndex(int index);
